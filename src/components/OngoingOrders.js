    ...
    <div className="bg-white" dir="rtl">
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          <h3 className="text-lg font-medium text-gray-900 mb-2">אין הזמנות זמינות</h3>
          <p className="text-gray-600">{selectedPickupSpot && selectedPickupSpot !== 'הכל' ? `לא נמצאו הזמנות באזור ${selectedPickupSpot}` : 'לא נמצאו הזמנות כרגע'}</p>
        </div>
      ) : (
